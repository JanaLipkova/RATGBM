...
test<-read.table( sprintf("../Patient01/Samples/ConvertedSamples/P01_samples_gen_%s.txt", GenID) )

png(filename =sprintf("../Patient01/Samples/LoopOut/P01_samples_gen_%s.png", GenID),width=1200,height=1200,units="px",pointsize=12,res=150,type=c("quartz"))
