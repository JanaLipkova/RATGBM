//
//  Glioma_ReactionDiffusionNecrosisOperator.h
//  GliomaXcode
//
        ...
        if(nDim == 2)
        {
            for(int iy=0; iy<BlockType::sizeY; iy++)
                for(int ix=0; ix<BlockType::sizeX; ix++)
                {
                    ...
                    o(ix, iy).necro = max((Real)0., o(ix, iy).necro);
                    o(ix, iy).necro = min((Real)1., o(ix, iy).necro);
